...
public class ActServiceCall implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        logger.debug("ActServiceCall begin...activity is [" + ((ActivityExecution) execution).getActivity().getId()
                + "] fields is" + toString());
    ...
    private void checkParms(DelegateExecution execution) throws BpmException {
        if (null == input_field || null == input_field.getValue(execution)
                || StringUtils.isBlank((String) input_field.getValue(execution))) {
        ...
        if (null == method || null == method.getValue(execution)
                || StringUtils.isBlank((String) method.getValue(execution))) {
        ...
        if (null == wsdl || null == wsdl.getValue(execution)
                || StringUtils.isBlank((String) wsdl.getValue(execution))) {
