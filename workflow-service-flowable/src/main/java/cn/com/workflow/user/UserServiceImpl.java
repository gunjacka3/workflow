...
//	private SpringHelper springHelper;
	...
	{
	    org.flowable.idm.api.User  user=identityService.newUser(_userId);
	...
	public void updateUserPassword(String _userId,String _password){
	    org.flowable.idm.api.User user=findUserById(_userId);
		user.setPassword(MD5Util.GetMD5Code(_password));
		identityService.saveUser(user);
	}
	...
	{
		Group group=identityService.newGroup(_groupName);
	 ...
	 * @return
	 */
	public org.flowable.idm.api.User findUserById(String _userId)
	{
